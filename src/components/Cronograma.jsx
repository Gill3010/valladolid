...
const schedule = {
  '7 Oct': [
    { time: '08:00', title: 'Conferencia Magistral de Apertura: Inteligencia Artificial y planeación docente: Riesgos y Desafíos', speaker: 'Antonio Jesús Santos — ITSVA', icon: Mic, type: 'keynote' },
    ...
    { time: '11:30', title: 'Conferencia Magistral: Investigación cualitativa en clave de inteligencia artificial: retos éticos, epistemológicos y pedagógicos en educación latinoamericana', speaker: 'Carlos Viltre — Centro Latinoamericano de Estudios en Epistemología Pedagógica', icon: Mic, type: 'keynote' },
    ...
    { time: '16:00', title: 'Conferencia Magistral de Cierre: La internacionalización en la Educación Superior como un factor generador de competencias educativas en los postgrados', speaker: 'Manuel Villero — University of Technology and Education', icon: Mic, type: 'keynote' },
  ...
  '8 Oct': [
    { time: '08:00', title: 'Conferencia Magistral de Apertura: Dilema Latinoamericano: Problemas socioeconómicos de la explotación de la minería a cielo abierto', speaker: 'Luis Barria — Universidad de Panamá', icon: Mic, type: 'keynote' },
    ...
    { time: '11:00', title: 'Conferencia Magistral: Dimensiones semánticas de la transformación digital: un enfoque integrado para la gestión de recursos y la sostenibilidad organizacional', speaker: 'Javier Cárcel-Carrasco — Universitat Politècnica de València', icon: Mic, type: 'keynote' },
    ...
    { time: '16:00', title: 'Conferencia Magistral de Cierre y Mesa de Debate: Estabilización de tecnología energética en sistemas de producción artesanal a partir de la producción cerámica rural en México', speaker: 'Faby Colmenero — Universidad Europea de Madrid', icon: Mic, type: 'keynote' },
    { time: '17:00', title: 'Visita cultural: Zona Arqueológica Ek Balam', speaker: 'Guía oficial certificada', icon: Award, type: 'social' },
  ],
  '9 Oct': [
    { time: '08:00', title: 'Conferencia Magistral de Apertura: Cinco décadas de industria maquiladora en el Norte de México desde una mirada femenina', speaker: 'Cirila Quintero Ramirez — El Colegio de la Frontera Norte', icon: Mic, type: 'keynote' },
    ...
    { time: '10:30', title: 'Receso / Café', speaker: '', icon: Coffee, type: 'break' },
    { time: '11:00', title: 'Conferencia Magistral: Enfoques metodológicos para la sostenibilidad, la innovación y la gestión empresarial en América Latina', speaker: 'Gladys Montalico — Universidad Nacional de Moquegua', icon: Mic, type: 'keynote' },
    ...
    { time: '16:00', title: 'Conferencia Magistral de Cierre: Interpretar el mundo en tiempos de crisis: aportes de la investigación cualitativa a la filosofía de la educación y la vida cotidiana', speaker: 'Flor Alba Aguilar — Universidad Politécnica Saleciana', icon: Mic, type: 'keynote' },
